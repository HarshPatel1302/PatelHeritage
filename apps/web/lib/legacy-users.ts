/**
 * Frozen snapshot of the resident roster that used to live in lib/auth.ts,
 * where it was bundled to the browser with plaintext passwords.
 *
 * This file is now SEED DATA ONLY — imported by prisma/seed.ts and never by
 * any client component. The database is the source of truth after seeding.
 */
...
export const MOCK_USERS: LegacyUser[] = [
  {
    "id": "chairman-1",
    "name": "Chairman",
