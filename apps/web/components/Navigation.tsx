...
export default function Navigation() {
  ...
  const allNavItemsList = [
    ...
    { path: '/wings', label: 'Wings', icon: Building2, public: true, excludeRole: ['cook', 'security', 'resident'] },
    ...
    { path: '/shops', label: 'Shops', icon: ShoppingBag, public: true, excludeRole: ['cook', 'security'] },
    { path: '/amenities', label: 'Amenities', icon: Users, public: true, excludeRole: ['cook', 'security'] },
    { path: '/announcements', label: 'Announcements', icon: Calendar, public: true },
